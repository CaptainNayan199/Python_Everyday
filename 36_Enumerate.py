...
# enumerate function is a built in function in python that allows us to loop over a sequence anf get the index and value of each element in the sequence at 
