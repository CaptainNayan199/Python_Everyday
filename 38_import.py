...
# But this is not recommended because it can create confusion, as well as, the size can be bigger as we have imported all those necessary functions that we are not using