...
# A simple program where theres en empty list, and user are asked about their favourite foods and is entered into the list. No problem right ? Now let's rewrite this program