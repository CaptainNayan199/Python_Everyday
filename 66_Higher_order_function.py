...
# Higher order functions are those types of function in python where a function is accepting another function as an argument or is returning some function