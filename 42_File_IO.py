...
# append()-a - this mode is used in opening a file in appending mode. Append means to add something in a particular things. As like write mode, this mode also creates a new file if the mentioned file is not found.
