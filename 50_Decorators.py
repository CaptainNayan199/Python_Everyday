...
@decor_func  #Now this one is very important, here we are saying our interpreter that decor_func is an decorator by using the @ symbol, the interpeter will understand it
def hello():
